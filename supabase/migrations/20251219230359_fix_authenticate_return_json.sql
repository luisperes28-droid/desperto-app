/*
  # Fix authenticate_user to return JSON

  1. Changes
    - Drop existing authenticate_user function that returns TABLE
    - Create new version that returns JSONB
    - Returns object with success, error, and user fields
    - Maintains bcrypt password verification

  2. Security
    - Function uses SECURITY DEFINER
    - Password verification with crypt()
